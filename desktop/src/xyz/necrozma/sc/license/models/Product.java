...
public class Product {
    ...
    public Product(int id, String name, LocalDateTime creationDate, String description, String password, boolean isPublic, AlgorithmTypes keyAlgorithm, xyz.necrozma.sc.license.models.FeatureDefinitions featureDefinitions, List<DataObject> dataObjects) {
        Id = id;
        Name = name;
